...
view: data_intelligence_otc {
  ...
  measure: Return_Order_Percentage {
    ...
    link: {
      ...
      url: "/Cortex_SAP_Operational/LookML_Dashboards/Returned_Order.dashboard.lookml"
    }
  ...
  measure: Cancelled_Order_Percentage {
    ...
    link: {
      ...
      url: "/Cortex_SAP_Operational/LookML_Dashboards/Canceled_Order.dashboard.lookml"
    }
  ...
  dimension: Tax_Amount_Global_Currency {
    ...
    sql: Round(if(${Local_Currency_Key}={% parameter Currency_Required %}  ,${Tax_Amount_Local_Currency},'supply-chain-twin-349311'.sct_cortex_reporting.Currency_Conversion( ${Client_ID},'M',${Local_Currency_Key},{% parameter Currency_Required %},${billing_date_for_billing_index_and_printout_date},${Tax_Amount_Local_Currency})),ifnull(CAST('supply-chain-twin-349311'.sct_cortex_reporting.Currency_Decimal({% parameter Currency_Required %}) AS int),2)) ;;
  }
  ...
  dimension: sales_order_net_price_Global_Currency {
    value_format: "0.00"
    type: number
    sql: Round(if(${Local_Currency_Key}={% parameter Currency_Required %}  ,${sales_order_net_price_local_currency},'supply-chain-twin-349311'.sct_cortex_reporting.Currency_Conversion( ${Client_ID},'M',${Local_Currency_Key},{% parameter Currency_Required %},${creation_date_date},${sales_order_net_price_local_currency})),ifnull(CAST('supply-chain-twin-349311'.sct_cortex_reporting}.Currency_Decimal({% parameter Currency_Required %}) AS int),2)) ;;
  }
  ...
  measure: sum_sales_order_net_value {
    ...
    link: {
      label: "Product"
      url: "/Cortex_SAP_Operational/LookML_Dashboards/Sales_Performance_By_Product.dashboard.lookml"
    }
  }
  ...
  measure: sum_sales_order_net_value_1 {
    ...
    link: {
      ...
      url: "/Cortex_SAP_Operational/LookML_Dashboards/Sales_Performance_By_Sales_Org.dashboard.lookml"
    }
  }
  ...
  measure: sum_sales_order_net_value_2 {
    ...
    link: {
      ...
      url: "/Cortex_SAP_Operational/LookML_Dashboards/Sales_Performance_By_Distribution_Channel.dashboard.lookml"
    }
  }
  ...
  measure: sum_sales_order_net_value_3 {
    ...
    link: {
      label: "Division"
      url: "/Cortex_SAP_Operational/LookML_Dashboards/Sales_Performance_By_Division.dashboard.lookml"
    }
  }
  ...
  measure: average_list_price1{
    ...
    link: {
      ...
      url: "/Cortex_SAP_Operational/LookML_Dashboards/Price_Adjustments_Based_on_Customer_profiling.dashboard.lookml"
    }
  ...
  measure: average_list_price2{
    ...
    link: {
      ...
      url: "/Cortex_SAP_Operational/LookML_Dashboards/Price_Adjustments_Based_on_Product_Availablity.dashboard.lookml"
    }
  ...
  dimension: One_Touch_Order_Count {
    ...
    link: {
      label: "One Touch Order"
      url: "/Cortex_SAP_Operational/LookML_Dashboards/One_Touch_Order.dashboard.lookml"
    }
  }
